<template>
    <q-dialog v-model="financeiroStore.modalConfirmacaoPagamento" persistent>
        <q-card>
            ...
            <q-card-actions align="right">
                <el-button @click="financeiroStore.modalConfirmacaoPagamento = false">Cancelar</el-button>
...
export default {
    ...
    methods: {
        ...
        async confirmar(){
            ...
            this.financeiroStore.modalConfirmacaoPagamento = false
