    ...
    <el-card class="box-card">
        <template #header>
            <div class="card-header">
                ...
                <el-button type="success" @click="fornecedorStore.novo()"
        ...
        <el-table v-if="fornecedorStore.fornecedores.length > 0" :data="fornecedorStore.fornecedores" stripe
            style="width: 99%">
            ...
            <el-table-column prop="acao" label="">
                <template #default="fornecedor">
                    <el-button type="primary" size="small" @click="fornecedorStore.exibir(fornecedor.row.uuid)" plain
